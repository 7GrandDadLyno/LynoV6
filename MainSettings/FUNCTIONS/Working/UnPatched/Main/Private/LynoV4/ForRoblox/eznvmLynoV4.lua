...
local CustomConfig = LIB("Render", {
    Name = "Break All Beds | Private",
    Function = function(callback) 
        if callback then
		notify("Waiting Script... start Farming Bed")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/eLeCtRaDoMiNuS/scriptsfrommybasement/main/breakallbeds.lua",true))()
        end
    end,
    Default = false,
    HoverText = "skidded"
...
open.Text = "LynoAntiCheat-Disabler"
